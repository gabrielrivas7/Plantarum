...
📌📌📌 Nota Importante: el nombre PLANTARUM, es referencial al dominio web WWW.plantarum.xyz, que se utiliza para poder alojar y ver el funcionamiento de la Dapp en línea con fines netamente educativos, para conceptualizar la idea funcional de un TFM, y NO es marca comercial, NI es nombre definitivo, es referencial, y se utilizó por la simple existencia y acceso al dominio plantarum.xyz, para poder alojar el prototipo bajo un nombre referencial y poder mostrar su funcionamiento. 
