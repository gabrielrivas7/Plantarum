## TRABAJO DE FIN DE MÁSTER DEL MÁSTER EN TECNOLOGÍA BLOCKCHAIN & SMART CONTRACTS DE LA UNIVERSIDAD DE SALAMANCA ESPAÑA ##
...
📌📌📌 Nota Importante: el nombre plantarum, es referencial al dominio plantarum.xyz, que se utiliza para poder alojar y ver el funcionamiento de la App en línea, y se utiliza para fines educativos, para conceptualizar la idea de un TFM, NO es marca comercial, NI es nombre definitivo, es referencial y se utilizó por la simple existencia y acceso al dominio plantarum.xyz para poder alojar el prototipo bajo un nombre referencial y poder mostrar su funcionando. 
